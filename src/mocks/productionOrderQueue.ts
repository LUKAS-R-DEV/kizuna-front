export interface IProductionOrder {
  ...
  materials: string[]; // Novo para match com UI
}
...
export const PRODUCTION_QUEUE_MOCK: IProductionOrder[] = [
  { 
    ...
    materials: ["Steel Plates", "Copper Wire"]
  },
  { 
    ...
    materials: ["Hydraulic Fluid", "Steel Plates"]
  },
  { 
    ...
    materials: ["Circuit Boards", "Plastic Casing", "Copper Wire"]
  }
];